    ...
    <section className='investor'>
      <div className='investor-content'>
        <div className='investor-content__left'>
          ...
          <Button type='primary' onClick={investorClickHandler}>
            Стать инвестором
          </Button>
        </div>
        <div className='investor-content__right'>
          <Paragraph>
            ...
            <ul>
              <li>Палатка и спальник</li>
              <li>Туалет под деревом</li>
              <li>Консервы</li>
              <li>Фонарик</li>
              <li>Посиделки у костра</li>
            </ul>
          </Paragraph>
          <Paragraph>
            <div style={{ display: 'flex' }}>
            ...
            <ul>
              <li>Купол с удобными кроватями</li>
              <li>Ванная комната и бассейн</li>
              <li>Ресторан и бар</li>
              <li>Электричество и wi-fi</li>
              <li>Да, посиделки у костра бесценны</li>
            </ul>
          </Paragraph>
        </div>
      </div>
