      ...
      <div>
        ...
        <Row className='about_app card'>
          <Col span={6}>
            ...
            >
              <p>
                В разделе <Link to='#'>Бронировать</Link> вы найдете огромную базу данных с разнообразными "Глэмпигами"
          ...
          <Col span={6}>
            <Card hoverable style={{ width: 250 }}>
              <p>
                В разделе <Link to='#'>Инвестировать</Link> наша команда профессионалов поможет разработать концепт и
