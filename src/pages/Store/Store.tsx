        ...
        <Sider width={180} className='site-layout-background'>
          <Menu mode='inline' style={{ height: '100%', borderRight: 0 }}>
            <SubMenu key='sub1' title='Цена'>
              <Menu.Item key='1'>Доргие ^</Menu.Item>
              <Menu.Item key='2'>Дешовые ^</Menu.Item>
            </SubMenu>
            ...
            <SubMenu key='sub3' title='Сезоность'>
              <Menu.Item key='9'>Лето</Menu.Item>
              <Menu.Item key='10'>Лето/Осень/Весна</Menu.Item>
              <Menu.Item key='11'>Всесезонный</Menu.Item>
            </SubMenu>
